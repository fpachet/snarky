# V19-K3-CONTEXTUAL-RHYTHMIC-GIBBS — génération sur rythme polyphonique réel
...
- `30` balayages Gibbs, graine `5517`.
- `18` facteurs K3 appris, sans règle historique.
...
- blocs avec croisement de voix : `3`.
