...
|---|---:|---:|---:|
| Demi-tons à la basse | 25.00 % | 26.27 % | 42.62 % |
| Répétitions à la basse | 3.71 % | 4.41 % | 4.01 % |
| Sauts de basse > 4 demi-tons | 27.87 % | 28.29 % | 7.04 % |
| Basse hors gamme naturelle globale | 7.14 % | 7.26 % | 15.40 % |
| Blocs triadiques (6 renversements) | 50.87 % | 54.76 % | 51.82 % |
| Blocs forts non triadiques | 26.91 % | 24.79 % | 23.89 % |
| Dissonances par bloc faible | 1.032 | 0.908 | 1.041 |
| Dissonances par bloc fort | 0.357 | 0.346 | 0.359 |
| {0,3,6,8} sur bloc fort | 1.40 % | 0.91 % | 2.72 % |
| {0,3,6,8} sur bloc faible | 3.07 % | 3.80 % | 6.61 % |
