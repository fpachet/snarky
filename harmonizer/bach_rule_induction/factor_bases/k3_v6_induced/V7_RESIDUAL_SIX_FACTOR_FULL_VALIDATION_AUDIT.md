...
|---|---:|---:|---:|
| Demi-tons à la basse | 25.67 % | 26.13 % | 26.46 % |
| Répétitions à la basse | 3.37 % | 4.42 % | 4.97 % |
| Sauts de basse > 4 demi-tons | 26.76 % | 27.25 % | 22.95 % |
| Basse hors gamme naturelle globale | 8.15 % | 9.68 % | 9.50 % |
| Blocs triadiques (6 renversements) | 52.74 % | 52.23 % | 51.37 % |
| Blocs forts non triadiques | 28.72 % | 31.30 % | 29.68 % |
| Dissonances par bloc faible | 0.987 | 0.893 | 0.967 |
| Dissonances par bloc fort | 0.410 | 0.449 | 0.422 |
| {0,3,6,8} sur bloc fort | 2.17 % | 1.92 % | 1.59 % |
| {0,3,6,8} sur bloc faible | 2.93 % | 4.24 % | 3.98 % |
...
- Demi-tons à la basse : `+0.792 pp` (IC95 `-1.067` à `+2.652`).
- Répétitions à la basse : `+1.597 pp` (IC95 `+0.727` à `+2.467`).
- Sauts de basse > 4 demi-tons : `-3.805 pp` (IC95 `-5.634` à `-1.977`).
- Basse hors gamme naturelle globale : `+1.345 pp` (IC95 `-0.091` à `+2.780`).
- Blocs triadiques (6 renversements) : `-1.370 pp` (IC95 `-3.493` à `+0.752`).
- Blocs forts non triadiques : `+0.958 pp` (IC95 `-2.499` à `+4.415`).
- Dissonances par bloc faible : `-0.020` (IC95 `-0.087` à `+0.047`).
- Dissonances par bloc fort : `+0.012` (IC95 `-0.047` à `+0.071`).
- {0,3,6,8} sur bloc fort : `-0.575 pp` (IC95 `-1.632` à `+0.482`).
- {0,3,6,8} sur bloc faible : `+1.057 pp` (IC95 `+0.306` à `+1.807`).
