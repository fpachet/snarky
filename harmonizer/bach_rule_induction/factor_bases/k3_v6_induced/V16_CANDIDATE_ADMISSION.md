...
| 5 | `any_voice_three_block_sign_shape(all_voices)=0,-1` | +0.150000 | +0.666 | 0.992 | true |
| 6 | `central_pair_abs_class(v0,v3)=3` | +0.150000 | -0.428 | 0.988 | false |
| 7 | `central_pair_abs_class(v2,v1)=7` | +0.150000 | -0.195 | 1.014 | false |
| 8 | `abs_class_from_previous(v3)=0` | +0.150000 | +0.909 | 0.970 | true |
...
| 12 | `any_voice_adjacent_abs_class(all_voices)=6` | -0.150000 | +0.600 | 0.972 | true |
