# V24-K3-CONTEXTUAL-RHYTHMIC-GIBBS — génération sur rythme polyphonique réel
...
- `1` passe(s) conjointe(s) de deux voix aux temps forts.
- `65` facteurs K3 appris, sans règle historique.
- `0` contraintes candidates appliquées avant normalisation.
