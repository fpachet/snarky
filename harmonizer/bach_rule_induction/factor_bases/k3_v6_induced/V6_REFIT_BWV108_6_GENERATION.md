# F-K3-CONTEXTUAL-RHYTHMIC-GIBBS — génération sur rythme polyphonique réel
...
- `30` balayages Gibbs, graine `1729`.
- `30` facteurs K3 appris, sans règle historique.
...
- blocs avec croisement de voix : `1`.
...
- Les activations K3 sont calculées par un fournisseur pur, puis évaluées par
  la base `FACTOR` Snarky sans effet de bord.
