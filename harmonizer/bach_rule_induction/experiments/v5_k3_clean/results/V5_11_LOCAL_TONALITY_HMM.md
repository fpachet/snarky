...
- Itérations EM : `15`.
- Probabilité de conserver le statut : `0.920`.
...
| Mesure | Valeur |
|---|---:|
| Gain de log-évidence par état sur tonique globale fixe | +1.380406 |
| États différents de la tonique globale | 33.38 % |
| Changements entre états adjacents | 9.52 % |
| Entropie postérieure normalisée | 0.030 |
| Classes rares avec référence globale | 3.780 % |
| Classes rares avec statut local | 1.242 % |
| Choix globalement rares devenant localement communs | 80.96 % |
