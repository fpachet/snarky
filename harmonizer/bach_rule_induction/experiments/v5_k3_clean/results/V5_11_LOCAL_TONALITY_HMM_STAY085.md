...
- Itérations EM : `15`.
- Probabilité de conserver le statut : `0.850`.
...
| Mesure | Valeur |
|---|---:|
| Gain de log-évidence par état sur tonique globale fixe | +1.367574 |
| États différents de la tonique globale | 33.78 % |
| Changements entre états adjacents | 10.33 % |
| Entropie postérieure normalisée | 0.033 |
| Classes rares avec référence globale | 3.780 % |
| Classes rares avec statut local | 1.189 % |
| Choix globalement rares devenant localement communs | 81.76 % |
