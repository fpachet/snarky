...
- [Corpus, simplification map and provenance](../benchmarks/data/omnibook_blues_v1/README.md)
...
variants. Boulez Blues has independently checked feasible solutions, but no
